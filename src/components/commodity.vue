<template>
    <div class="commodity-menu" id="commodity">
        <el-table border :data="goodsList" max-height="500" overflow="scroll" ref="multipleTable" tooltip-effect="dark" style="width: 100%" :isSeckillGoods="isSeckillGoods" @selection-change="handleSelectionChange">
