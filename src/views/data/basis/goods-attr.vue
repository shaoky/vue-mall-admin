<template>
    <div class="merchants-goods">
        ...
        <el-table class="mt20" border :data="list">
            ...
            <el-table-column label="可选值列表" prop="attrContent"></el-table-column>
        ...
        <el-dialog :title="isAdd ? '新增属性' : '编辑属性'" :visible.sync="dialogVisible" width="500px" center>
                <el-form label-width="120px">
                    ...
                    <el-form-item label="属性类型：">
                        <el-radio v-model="form.attrType" :label="1">手工录入</el-radio>
                        <el-radio v-model="form.attrType" :label="2">单选属性</el-radio>
                        <el-radio v-model="form.attrType" :label="3">多选属性</el-radio>
                    ...
                    <el-form-item label="可选值：" v-if="form.attrType !== 1">
...
<script>
import { getGoodsAttrList, addGoodsAttr, delGoodsAttr, updateGoodsAttr, getGoodsBasisInfo } from '@/api/getData'
